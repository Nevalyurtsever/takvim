...
function categoryLabel(c){return({international:'International',culture:'Kültür',social:'Sosyal',edu:'Eğitim',lang:'Dil',web:'Webinar'}[c]||'Etkinlik');}
...
function safeImg(img,title){ img.loading='lazy'; img.onerror=()=>{ console.error('Görsel yok:',img.src); img.src=placeholderDataURL(title);} }

// ---- ETKİNLİKLER (görsel adlarını assets_final.zip’te verdiğimle eşleştir) ----
const EVENTS = [
  ...
  { id:'2025-10-25-international', title:'International Programs', date:'2025-10-25', time:'15:00', category:'international',
    image:'assets/culture-exchange.jpg', detailImage:'assets/culture-exchange.jpg',
    location:'Vistula University', summary:'Holidays and Celebrations – International Programs.', tags:['International'] },
